...
class TestContactMethodRoutes < RouteTester
  ...
  def test_update
    ...
    patch_as_fetch 'masterfiles/parties/contact_methods/1', {}, 'rack.session' => { user_id: 1, last_grid_url: DEFAULT_LAST_GRID_URL }
  ...
  def test_delete
    ...
    delete_as_fetch 'masterfiles/parties/contact_methods/1', {}, 'rack.session' => { user_id: 1, last_grid_url: DEFAULT_LAST_GRID_URL }
