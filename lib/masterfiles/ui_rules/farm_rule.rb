...
module UiRules
  class FarmRule < Base
    ...
    def set_show_fields
      ...
      fields[:owner_party_role_id] = { renderer: :label, with_value: owner_party_role_id_label, caption: 'Farm Owner' }
      ...
      fields[:puc_id] = { renderer: :label, with_value: puc_id_label, caption: 'Primary Puc' }
    ...
    def common_fields
      ...
      {
        owner_party_role_id: { renderer: :select, options: MasterfilesApp::PartyRepo.new.for_select_party_roles, required: true, caption: 'Farm Owner' },
        pdn_region_id: { renderer: :select, options: @repo.for_select_production_regions, disabled_options: @repo.for_select_inactive_production_regions, required: true },
        farm_group_id: { renderer: :select, options: @repo.for_select_farm_groups, disabled_options: @repo.for_select_inactive_farm_groups, required: true },
        farm_code: { required: true },
        description: {},
        active: { renderer: :checkbox },
        puc_id: { renderer: :select, options: farm_pucs, disabled_options: @repo.for_select_inactive_pucs, caption: 'Primary Puc' }
